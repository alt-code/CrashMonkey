...
function processOutput(output, testIdFile) {
    ...
    output.results[0].count = parseInt(output.results[0].count);
    output.results[1].count = parseInt(output.results[1].count);
    output.results[2].count = parseInt(output.results[2].count);
